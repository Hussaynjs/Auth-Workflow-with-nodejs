...
const {sendVerificationEmail, sendResetPassword,hashPassword} = require('../utils')
const { createTokenUser,
    attachCookiesToResponse,} = require('../utils')
...
const login = async(req, res) => {
    ...
    res.status(StatusCodes.OK).json({tokenUser, userToken})
...
const forgotPassword = async(req, res) => {
    ...
    if(user){
       ...
       await  sendResetPassword({
        ...
        user.passwordToken = hashPassword(passwordToken);
...
const resetPassword = async(req, res) => {
    ...
    if(user){
        ...
        if(user.passwordToken === hashPassword(token) && user.passwordTokenExpirationDate > currntDate){
